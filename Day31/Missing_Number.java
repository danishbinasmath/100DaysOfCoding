...
//    Method 2
    //rootThe basic idea is to use XOR operation.
    //We all know that a^b^b =a, which means two xor operations
    ...
    //be perfectly corresponding( nums[index] = index), so in a missing array,
